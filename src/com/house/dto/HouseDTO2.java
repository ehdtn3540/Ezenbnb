...
public class HouseDTO2 {
	...
	public HouseDTO2(int hidx, int midx, String hname, String hcatg, String haddress, String hphone, String himage,
			String hfacility, int hgrade, int hbed, int hbat, int hperson, int hprice, int hutill, String uidx,
			String uname) {
		super();
		this.hidx = hidx;
		this.midx = midx;
